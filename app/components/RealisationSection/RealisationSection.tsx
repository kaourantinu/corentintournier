...
export default function RealisationSection(){
    ...
    const projects = [
        ...
        {id: 3, name: 'bgremover', imageUrl: '/bgremoverwebsite.png', description: "Un outil réalisé avec Next.js permettant de retirer l'arrière-plan d'une image choisie et cela, en un clic et quelques secondes. bgremover envoie l'image choisie par l'utilisateur à l'API publique de remove.bg afin d'en retirer l'arrière-plan. L'outil est limité à 150 images traitées par mois.", projectUrl: 'https://bgremover-ashen.vercel.app/', githubAccess: 'https://github.com/kaourantinu/bgremover', technos: ["Next.js", "TypeScript", "API Remove.Bg"]},
        {id: 4, name: 'Showroom iPhone', imageUrl: '/iphonewebsite.png', description: "Un showroom interactif Apple présentant l'iPhone 15 Pro. Il utilise la puissance de three.js et de la 3D afin de présenter le nouveau téléphone d'Apple à travers un configurateur gérant la couleur, la quantité de stockage, tout en adaptant le prix de vente.", projectUrl: 'https://appleiphone15pro.vercel.app/', githubAccess: 'https://github.com/kaourantinu/appleiphone15pro', technos: ["Next.js", "TypeScript", "three.js"]},
        {id: 5, name: 'corentintournier/', imageUrl: '/corentinwebsite.png', description: "Le site internet sur lequel vous êtes actuellement ! Ce site présente mon profil : celui d'un développeur web junior React/Next.js. Vous me découvrez à travers les technologies web que j'utilise, mes réalisations, mes expériences, mon diplôme et mon clone AI 3D géré par ChatGPT.", projectUrl: 'https://corentintournier.fr/', githubAccess: 'https://github.com/kaourantinu/corentintournier', technos: ["Next.js", "TypeScript", "three.js", "API ChatGPT"]},
        {id: 6, name: 'Smayi', imageUrl: '/smayiwebsite.png', description: "Mon premier projet SAAS ayant pour ambition de faciliter la construction de stratégies Social Media et la rédaction de publications pour les réseaux sociaux grâce à l'IA. (Projet encore en cours de développement, contactez-moi pour une démonstration).", projectUrl: 'mailto:corentin.tournier@outlook.fr', technos: ["Next.js", "TypeScript", "API ChatGPT", "NextAuth"]},
    ]
    ...
    return(
        <section id={`${styles.realisationsection}`} className='container'>
            <div id={styles.realisationinfo} className="horizontalslide">
                ...
                {currentProject.githubAccess ? (
                <Link href={currentProject.githubAccess} target='_blank' rel='noreferrer noopener' className='borderbutton'>GitHub du projet <FiExternalLink /></Link>
                ) : (
                    null
                )
                }
